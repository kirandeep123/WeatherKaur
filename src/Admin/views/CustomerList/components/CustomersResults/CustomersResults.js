...
import { ReviewStars } from 'common/components';
import { MoreButton } from 'Admin/components';
                        ...
                        <div className={classes.nameCell}>
                          ...
                          <div>
                            <Link
                              ...
                              to={`/admin/management/customers/${customer.slug}`}
                              variant="h6"
                            >
                              {customer.name}
                            </Link>
